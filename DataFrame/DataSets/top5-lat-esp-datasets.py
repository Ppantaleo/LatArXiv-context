...
# Orden predefinido de los países
orden_paises = ['pe', 'br', 'es', 'co', 'ar', 'ec', 'mx', 'cl', 'cu', 'ni', 'sv', 'uy', 'pa', 'cr']
...
content_types_interes = ['datasets', 'theses_and_dissertations']
...
# Exportar a HTML
ruta_html = r"C:\Users\Patricio\Documents\GitHub\LatArXiv-context\DataFrame\DataSets\top_5_lat_esp_datasets.html"
